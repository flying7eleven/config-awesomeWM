...
myTags = {
	...
	{ name = "3:im",		layout = awful.layout.suit.fair,		wmfact = 0.5 },
	{ name = "4:terminal",	layout = awful.layout.suit.tile.bottom,	wmfact = 0.5 },
	{ name = "5:devel",		layout = awful.layout.suit.max,			wmfact = 1.0 },
	{ name = "6:NA",		layout = awful.layout.suit.tile.left,	wmfact = 1.0 },
	{ name = "7:NA",		layout = awful.layout.suit.tile.left,	wmfact = 1.0 },
